    ...
    public function run(): void
    {
        ...
        $standardParks = [
            ...
            [
                ...
                'area' => '3.9',
                'operator' => 'Компанія 2',
                'description' => 'Парк воїнів-інтернаціоналістів у Франківську знаходиться на перетині вулиць Галицької та Василіянок. Ним часто проходять у справах мешканці або ж гуляють з дітьми чи собаками.',
